...
@objc open class SwiftyMarkdown: NSObject {
    ...
    static public var characterRules = [
        ...
        CharacterRule(primaryTag: CharacterRuleTag(tag: "<u>", type: .open), otherTags: [
            CharacterRuleTag(tag: "</u>", type: .close)
        ], styles: [1 : CharacterStyle.underlinedText], metadataLookup: false, definesBoundary: true),
...
extension SwiftyMarkdown {
    ...
    func attributedStringFor( tokens : [Token], in line : SwiftyLine ) -> NSAttributedString {
        ...
        for token in finalTokens {
            ...
            if styles.contains(.underlinedText) {
